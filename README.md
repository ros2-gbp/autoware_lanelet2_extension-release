## autoware_lanelet2_extension (jazzy) - 1.1.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy autoware_lanelet2_extension` on `Fri, 08 May 2026 09:43:45 -0000`
...
## autoware_lanelet2_extension (rolling) - 1.1.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling autoware_lanelet2_extension` on `Fri, 08 May 2026 09:39:21 -0000`
...
## autoware_lanelet2_extension (humble) - 1.1.0-3

The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_lanelet2_extension` on `Tue, 05 May 2026 03:38:28 -0000`
...
## autoware_lanelet2_extension (humble) - 1.1.0-2

The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_lanelet2_extension` on `Mon, 04 May 2026 15:54:12 -0000`
...
## autoware_lanelet2_extension (humble) - 1.1.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_lanelet2_extension` on `Mon, 04 May 2026 15:46:49 -0000`
...
## autoware_lanelet2_extension (rolling) - 1.0.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling autoware_lanelet2_extension -y` on `Fri, 01 May 2026 23:13:37 -0000`
...
## autoware_lanelet2_extension (humble) - 1.0.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble autoware_lanelet2_extension -y` on `Fri, 01 May 2026 23:12:07 -0000`
...
## autoware_lanelet2_extension (jazzy) - 1.0.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy autoware_lanelet2_extension -y` on `Fri, 01 May 2026 23:07:52 -0000`
...
## autoware_lanelet2_extension (humble) - 0.10.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble autoware_lanelet2_extension -y` on `Tue, 11 Nov 2025 11:56:20 -0000`
...
## autoware_lanelet2_extension (humble) - 0.8.0-1

The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_lanelet2_extension` on `Fri, 25 Jul 2025 06:51:48 -0000`
...
## autoware_lanelet2_extension (rolling) - 0.7.2-1

The packages in the `autoware_lanelet2_extension` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling autoware_lanelet2_extension` on `Wed, 14 May 2025 04:54:32 -0000`
...
## autoware_lanelet2_extension (jazzy) - 0.7.2-1
...
The packages in the `autoware_lanelet2_extension` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling autoware_lanelet2_extension` on `Fri, 25 Apr 2025 07:56:42 -0000`
...
The packages in the `autoware_lanelet2_extension` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy autoware_lanelet2_extension` on `Thu, 05 Sep 2024 00:42:56 -0000`
